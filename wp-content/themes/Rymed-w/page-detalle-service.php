      ...
      <section id="vertical_tab_nav">
        ...
        <div class="tab_container">
          ...
          <article id="tab1">
            <div class="row">
              <div class="col-sm-12 col-md-6">
                ...
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/hloo-22.jpg" class="img-fluid mb-4" alt="Responsive image" />
          ...
          <article id="tab3">
            ...
            <div class="row">
              ...
              <div class="col-sm-12 col-md-6">
                ...
                <img class="img-diva" src="<?php echo get_template_directory_uri(); ?>/assets/img/diva.png" alt="">
              </div>
            </div>
          </article>
          ...
          <article id="tab4">
            ...
            <img class="bbl-img" src="<?php echo get_template_directory_uri(); ?>/assets/img/BBL.svg" alt="">
          </article>
        </div>
      </section>
    </div>
